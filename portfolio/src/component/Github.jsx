     ...
     <ScrollTrigger onEnter={() => setCouter(true)} onExit={() => setCouter(false)}>
      <Container maxW={"container.xl"} mt={"10"}  >
        <Box  className="react-activity-calendar" fontWeight={"extrabold"} color={"whiteAlpha.600"}  ><GitHubCalendar  username="diwakarsharma2216"     /> </Box>
         ...
         {  counter &&  < CountUp   start={0} end={1400} duration={3} />}
         <span style={{fontSize:"15px"}}>+ Hours of Coding</span>
         </Box>
         <Box>
     { counter &&  <CountUp   start={0} end={800} duration={3} />}
         <span style={{fontSize:"15px"}}>+ Hours of DSA</span>
         </Box>
         <Box>
      { counter &&  <CountUp  start={0} end={5} duration={3} />}
         <span style={{fontSize:"15px"}}>+ Mega-Project</span>
         </Box>
         <Box>
 { counter && <CountUp start={0} end={8} duration={3} />}
        ...
        <Flex gap={{base:"1",md:"10"}}   direction={{base:"column",md:"row"}}>
         ...
         <Image   h="170px"  id="github-streak-stats"  src="https://github-readme-streak-stats.herokuapp.com?username=ashu7982&theme=merko&hide_border=true&type=png" />
          </Box>
          <Box  data-aos="fade-left" h="170px"  >
          <Image  h="170px"   id="github-top-langs"  src="https://github-readme-stats.vercel.app/api/top-langs/?username=ashu7982&theme=merko&hide_border=true&hide_progress=true" />
          </Box>
          <Box  h="170px" data-aos="fade-left"  >
          <Image  h="170px"   id="github-stats-card"  src="https://github-readme-stats.vercel.app/api?username=ashu7982&theme=merko&&hide_border=true&hide=contribs,prs" />
          </Box>
        </Flex>
      </Container>
      </ScrollTrigger>
...
//https://github-readme-streak-stats.herokuapp.com?username=ashu7982&theme=merko&hide_border=true&type=png